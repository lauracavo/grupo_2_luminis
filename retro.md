...
Principalmente a partir de este Sprint se redujo la cantidad de participantes de 7 a 6 integrantes.

1) Comenzar hacer (Start Doing):
<!-- -Dividir equitativamente las tareas de los sprint.(aún no se encontró de una manera óptima dividir tareas equitativas). -->(-Comenzamos a ingresar todas las actividades del Sprint en el Trello para luego cada participante, tome alguna/s tarjetas para empezar a trabajar)
<!-- -Implementar unas ciertas reglas o formatos a seguir, en la implementación de los códigos tanto para HTML como para CSS. -->(Partials)
-Tener reuniones presenciales, fortalecería el grupo de trabajo


2) Hacer Más (More of):
-Realizar más de 2 encuentros semanales por zoom.(Para mejorar deberíamos tratar de intentar que se cumpla con la asistencia en los encuentros semanales.)
-Al utilizar los Partials, se pudo mejorar en cuestión de implementación de un código más limpio y ordenado.
-Todos tengan la prioridad del curso.
-Estar continuamente observando el proyecto para mejorarlo/optimizarlo.
...
-Grupo completo tener clonado el repositorio.
-Ayudar a los compañeros que tengan alguna dificultad en el proyecto.
-Seguir con la comunicación que vamos llevando, ya que ha mejorado, (consideradamente, al estar usando WhatsApp como medio de comunicación principal).
...
5) Dejar de hacer (Stop Doing):
<!-- -Pensar que es lo que tenemos que realizar en los Sprints 5,6,7 cuando recién apenas estamos en los primeros Sprints. -->(Listo)
-Hablar por encima de otro compañero mientras está hablando. (En este aspecto se ha mejorado demasiado)
-Darle prioridad a trabajos personales del Playground, en vez de realizar la actividad grupal.(Logrado)
...
<!-- -Dividir equitativamente las tareas de los sprint.(aún no se encontró de una manera óptima dividir tareas equitativas). -->(-Comenzamos a ingresar todas las actividades del Sprint en el Trello para luego cada participante, tome alguna/s tarjetas para empezar a trabajar)
<!-- -Implementar unas ciertas reglas o formatos a seguir, en la implementación de los códigos tanto para HTML como para CSS. -->(Partials)
-Tener reuniones presenciales, fortalecería el grupo de trabajo (se ha logrado concretar algunos encuentros presenciales)

2) Hacer Más (More of):
-Realizar más de 2 encuentros semanales por zoom.(Para mejorar deberíamos tratar de intentar que se cumpla con la asistencia en los encuentros semanales.),( Actualmente nos comunicamos demasiado por WhatsApp, en lo cual continuamente preguntamos cómo vamos con el proyecto y hacia donde nos dirigimos.)
-Al utilizar los Partials, se pudo mejorar en cuestión de implementación de un código más limpio y ordenado.
-Todos tengan la prioridad del curso. (Todos acordamos con eso).
-Estar continuamente observando el proyecto para mejorarlo/optimizarlo. (En curso).
...
-Ayudar a los compañeros que tengan alguna dificultad en el proyecto.
-Seguir con la comunicación que vamos llevando, ya que ha mejorado, (consideradamente, al estar usando WhatsApp como medio de comunicación principal).
-Al dividir las tareas en tarjetas, podemos elegir la opción que nos sentimos más cómodos para poder realizar.

4) Hacer menos (Less of): 
<!-- -Tener ideas muy complejas al respecto sobre el proyecto de la página web, si bien es genial poder intentar realizar todos los detalles que estuvimos hablando, también hay que entender que tiempo que llevaría dichas modificaciones puede implicar un riesgo en llegar a realizar el User Interface y el User Experiencie.  -->(Solamente nos concentramos en el sprint Actual, y pequeñas modificaciones de sprint anteriores y algunos conceptos del Sprint que sigue).
-En los encuentros semanales, tratar de hablar sobre el sprint Actual, para otras dudas de los proyectos personales, sería mejor comentarlo en otro horario. (Bastante logrado)
